   ...
   <div id="clinic">
      ...
      <div id="boxform">
         ...
         <table style="width:70%  ; margin-left: 15%;">
                <thead>
                  <tr>
                     <td colspan=6  height="80" width="100"> <font size="7" color ="#509897"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รายชื่อบุคลากร</font><br>
                     </td>
                  </tr>
                ...
                <tbody>
                   ...
                   <tr>
                     ...
                     <td colspan=6 height="80" > <button onclick="location.href='edit_employee.php'" id="FFbutton"></button> <button onclick="location.href='../insert_vet_emp.html'" id="Addbutton1"></button><button onclick="location.href='../insert_ass_emp.html'" id="Addbutton2"></button></td>
                 </tr>
