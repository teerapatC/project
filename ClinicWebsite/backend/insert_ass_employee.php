...
$e_licenofassistance = $_POST["e_licenofassistance"];
...
$sql = "INSERT INTO assistance
(Empid, Name, StartDate, Salary, LicenOfAssistance, HouseNo, Code, Province, Street, District)
VALUES
('$e_id', '$e_name', '$e_startDate', '$e_salary', '$e_licenofassistance',  '$e_houseNo', '$e_code', '$e_province', '$e_street', '$e_district')";
$result = mysqli_query($condb, $sql);
