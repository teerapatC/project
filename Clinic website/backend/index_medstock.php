...
<div>
   ...
   <div id="boxform">
        ...
        <table style="width:70%  ; margin-left: 15%;">
                  <thead>
                    <tr>
                        <td colspan=3  height="80" width="100"> <font size="7" color ="#265a66" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Medicine stock </font></td>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td colspan=3 height="80" ><button onclick="location.href='edit_medStock.php'" id="FFbutton"></button></td>
                    </tr>
        ...
        <!-- <div>
            <form style = "margin-left:220px" action="serch_medData.php" method="POST">
                <font size="5" color ="#265a66"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ค้นหาข้อมูล </font>
                <input style = "" type="text" placeholder="ป้อนชื่อยาที่ต้องการค้นหา" name="serchname">
                <input type="submit" value="ค้นหา">
            </form>
        </div> -->
        <form style = "margin-left:2px" action="serch_medData.php" method="POST">
            <div class="search-box" >
                <button type="submit" value="ค้นหา" class="btn-search"></button>
                <input type="text" class="input-search" placeholder="ค้นหาชื่อยา" name="serchname" >
            </div>
        </form>   
