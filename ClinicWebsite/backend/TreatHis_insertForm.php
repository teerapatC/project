...
<body>
    ...
    <h2 style="color: #265a66;" class="text-center">&emsp;&emsp;แบบฟอร์มบันทึกข้อมูลตารางนัดหมาย</h2>
    <form action="TreatHis_insertData.php" method="POST">
        <div class="form-group">
            <label for="bookingdate">&emsp;     วัน เวลานัดหมาย</label>
            <input type="datetime-local" name="bookdate" id="" >
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="animalid" id="" class ="form-control">
        </div>
        <div class="form-group">
            <label for="citizenID">&emsp;ID สัตวแพทย์</label>
            <input type="text" name="citizenid" id="" class ="form-control">
        </div>
      
       

        <input style=" border-radius: 50px; padding: 0.4em 1em; background-color:  #265a66; color:#e6e6e6 ;font-size: 1.5em; " type="submit" value="บันทึกข้อมูล" class = "btn btn-success" >
        ...
        <a style=" border-radius: 50px; padding: 0.7em 1em; background-color: #265a66; color:#e6e6e6 ;font-size: 1.5em; margin-left:25cm" href="TreatHis_index.php"class="btn btn-primary" style="float: right;">ย้อนกลับ</a>
